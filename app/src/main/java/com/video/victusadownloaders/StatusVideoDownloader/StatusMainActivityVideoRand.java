...
public class StatusMainActivityVideoRand extends AppCompatActivity implements View.OnClickListener {

    StatusMainActivityVideoRand activity;
...
//    };
    ...
    public void callJoshActivity() {
        AdsWork.showInterAds(StatusMainActivityVideoRand.this, new AdsWork.AdFinished() {
            @Override
...
//            }
//        }
        if (!PermissionUtil.isAllStoragePermissionsGranted(StatusMainActivityVideoRand.this)) {
...
//                            String[listPermissionsNeeded.size()]), type);
            PermissionUtil.requestAllStoragePermissions(StatusMainActivityVideoRand.this,type);
            return false;
        } else {
            if (type == 100) {
                callLikeeActivity();
    ...
    public void onBackPressed() {
        StatusMainActivityVideoRand.super.onBackPressed();
    }
    ...
    public void setLocale(String lang) {
        ...
        Intent refresh = new Intent(StatusMainActivityVideoRand.this, StatusMainActivityVideoRand.class);
