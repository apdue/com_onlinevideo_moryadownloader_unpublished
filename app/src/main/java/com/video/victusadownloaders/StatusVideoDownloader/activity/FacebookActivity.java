...
import static com.video.victusadownloaders.StatusVideoDownloader.util.Utils.RootDirectoryFacebook;
...
import com.video.victusadownloaders.StatusVideoDownloader.adapter.FBStoriesListAdapter;
import com.video.victusadownloaders.StatusVideoDownloader.adapter.FbStoryUserListAdapter;
...
import com.video.victusadownloaders.StatusVideoDownloader.model.FBStoryModel.EdgesModel;
import com.video.victusadownloaders.StatusVideoDownloader.model.FBStoryModel.MediaModel;
...
public class FacebookActivity extends AppCompatActivity implements UserListInterface {
    ...
    private void initViews() {
        ...
        binding.tvPaste.setOnClickListener(view -> {
            AdsWork.showInterAds(FacebookActivity.this, new AdsWork.AdFinished() {
                @Override
