...
import static com.video.victusadownloaders.StatusVideoDownloader.util.Utils.RootDirectoryInsta;
...
import com.video.victusadownloaders.StatusVideoDownloader.adapter.StoriesListAdapter;
import com.video.victusadownloaders.StatusVideoDownloader.adapter.UserListAdapter;
...
import com.video.victusadownloaders.StatusVideoDownloader.model.Edge;
import com.video.victusadownloaders.StatusVideoDownloader.model.EdgeSidecarToChildren;
import com.video.victusadownloaders.StatusVideoDownloader.model.FBStoryModel.NodeModel;
import com.video.victusadownloaders.StatusVideoDownloader.model.ResponseModel;
import com.video.victusadownloaders.StatusVideoDownloader.model.story.FullDetailModel;
import com.video.victusadownloaders.StatusVideoDownloader.model.story.StoryModel;
...
public class InstagramActivity extends AppCompatActivity implements UserListInterface {
    ...
    private void initViews() {
        ...
        binding.loginBtn1.setOnClickListener(v -> {
            ...
            if (LL.equals("")) {
                ...
                AdsWork.showInterAds(InstagramActivity.this, new AdsWork.AdFinished() {
                    @Override
    ...
    private String getUrlForReelsWithoutParameters(String str) {
        try {
            URI uri = new URI(str);
            //System.out.println("Rajan_uri.getFragment()"+uri.getFragment());
//            String insstr =  URI.create(uri.getScheme() + "://" + uri.getAuthority() + uri.getPath() + "#" + uri.getFragment()).toString()
//                    .replace("reel", "tv");
    ...
    private void callDownload(String Url) {
        String a = !Url.equals("www.instagram.com") && !Url.equals("instagram.com") && Url.contains("https://www.instagram.com/reel")
                ? getUrlForReelsWithoutParameters(Url) : getUrlWithoutParameters(Url);

        a = a +  "?__a=1&__d=dis";

        String UrlWithoutQP;
//        UrlWithoutQP = getUrlWithoutParameters(Url);
        ...
        try {
            ...
            if (Utils.isNetworkAvailable()) {
                if (commonClassForAPI != null) {
                    ...
                    // System.out.println("Rajan_insta_act_UrlWithoutQP"+UrlWithoutQP);
