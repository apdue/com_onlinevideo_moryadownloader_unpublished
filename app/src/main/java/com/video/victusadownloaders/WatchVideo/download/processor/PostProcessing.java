...
import com.video.victusadownloaders.WatchVideo.download.io.ChunkFileInputStream;
import com.video.victusadownloaders.WatchVideo.download.io.CircularFileWriter;
import com.video.victusadownloaders.WatchVideo.download.io.ProgressReport;
...
public abstract class PostProcessing implements Serializable {
	...
	static transient final byte OK_RESULT = DownloadMission.ERROR_NOTHING;
			...
			try {
				...
				if (test(sources)) {
					...
					out.onWriteError = (err) -> {
						...
						return mission.errCode == DownloadMission.ERROR_NOTHING;
					};
