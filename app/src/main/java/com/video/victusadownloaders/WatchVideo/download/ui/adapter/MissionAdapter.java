...
import static com.video.victusadownloaders.WatchVideo.download.helper.DownloadMission.ERROR_CONNECT_HOST;
import static com.video.victusadownloaders.WatchVideo.download.helper.DownloadMission.ERROR_FILE_CREATION;
import static com.video.victusadownloaders.WatchVideo.download.helper.DownloadMission.ERROR_HTTP_NO_CONTENT;
import static com.video.victusadownloaders.WatchVideo.download.helper.DownloadMission.ERROR_INSUFFICIENT_STORAGE;
import static com.video.victusadownloaders.WatchVideo.download.helper.DownloadMission.ERROR_NOTHING;
import static com.video.victusadownloaders.WatchVideo.download.helper.DownloadMission.ERROR_PATH_CREATION;
import static com.video.victusadownloaders.WatchVideo.download.helper.DownloadMission.ERROR_PERMISSION_DENIED;
import static com.video.victusadownloaders.WatchVideo.download.helper.DownloadMission.ERROR_POSTPROCESSING;
import static com.video.victusadownloaders.WatchVideo.download.helper.DownloadMission.ERROR_POSTPROCESSING_HOLD;
import static com.video.victusadownloaders.WatchVideo.download.helper.DownloadMission.ERROR_POSTPROCESSING_STOPPED;
import static com.video.victusadownloaders.WatchVideo.download.helper.DownloadMission.ERROR_PROGRESS_LOST;
import static com.video.victusadownloaders.WatchVideo.download.helper.DownloadMission.ERROR_RESOURCE_GONE;
import static com.video.victusadownloaders.WatchVideo.download.helper.DownloadMission.ERROR_SSL_EXCEPTION;
import static com.video.victusadownloaders.WatchVideo.download.helper.DownloadMission.ERROR_TIMEOUT;
import static com.video.victusadownloaders.WatchVideo.download.helper.DownloadMission.ERROR_UNKNOWN_EXCEPTION;
import static com.video.victusadownloaders.WatchVideo.download.helper.DownloadMission.ERROR_UNKNOWN_HOST;
...
import com.video.victusadownloaders.WatchVideo.download.helper.DownloadMission;
import com.video.victusadownloaders.WatchVideo.download.helper.FinishedMission;
import com.video.victusadownloaders.WatchVideo.download.helper.Mission;
...
import com.video.victusadownloaders.WatchVideo.download.ui.common.Deleter;
import com.video.victusadownloaders.WatchVideo.download.ui.common.ProgressDrawable;
		...
		ExtractorHelper.getStreamInfo(Constants.YOUTUBE_SERVICE_ID, item.mission.source, false)
				...
				.observeOn(AndroidSchedulers.mainThread()).subscribe(
						...
						streamInfo -> {
							...
							GlideUtils.loadThumbnail(AppNew.getAppContext(), h.icon, thumbnailUrl);
						},
						// onError
						throwable -> {
						});
