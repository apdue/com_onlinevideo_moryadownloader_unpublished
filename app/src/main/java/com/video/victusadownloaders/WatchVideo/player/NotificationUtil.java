...
public final class NotificationUtil {
    ...
    private synchronized NotificationCompat.Builder createNotification(final VideoPlayerImpl player) {
        ...
        builder.setStyle(new androidx.media.app.NotificationCompat.MediaStyle()
                ...
                .setDeleteIntent(PendingIntent.getBroadcast(player.context, NOTIFICATION_ID, new Intent(MainPlayer.ACTION_CLOSE), FLAG_IMMUTABLE));
    ...
    private NotificationCompat.Action getAction(final VideoPlayerImpl player, @NotificationConstants.Action final int selectedAction) {
        ...
        switch (selectedAction) {
            case NotificationConstants.PREVIOUS:
                return getAction(player, baseActionIcon, R.string.exo_controls_previous_description, MainPlayer.ACTION_PLAY_PREVIOUS);

            case NotificationConstants.NEXT:
                return getAction(player, baseActionIcon, R.string.exo_controls_next_description, MainPlayer.ACTION_PLAY_NEXT);

            case NotificationConstants.REWIND:
                return getAction(player, baseActionIcon, R.string.exo_controls_rewind_description, MainPlayer.ACTION_FAST_REWIND);

            case NotificationConstants.FORWARD:
                return getAction(player, baseActionIcon, R.string.exo_controls_fastforward_description, MainPlayer.ACTION_FAST_FORWARD);
