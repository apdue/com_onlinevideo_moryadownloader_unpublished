...
public class DummyFiveScr extends AppCompatActivity {
    ...
    private void startActivity() {
        Intent intent;
        if (new PrefManagerVideo(DummyFiveScr.this).getString(SplashActivityScr.status_dummy_six_enabled).contains("true")) {
            intent = new Intent(DummyFiveScr.this, DummySixScr.class);
        } else {
            intent = new Intent(DummyFiveScr.this, HomeActivityScr.class);
        }
