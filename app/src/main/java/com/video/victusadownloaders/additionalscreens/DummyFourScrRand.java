...
public class DummyFourScrRand extends AppCompatActivity {
    ...
    private void startActivity() {
        Intent intent;
        if (new PrefManagerVideo(DummyFourScrRand.this).getString(SplashActivityScr.status_dummy_five_enabled).contains("true")) {
            intent = new Intent(DummyFourScrRand.this, DummyFiveScrRand.class);
        }
        else  if (new PrefManagerVideo(DummyFourScrRand.this).getString(SplashActivityScr.status_dummy_six_enabled).contains("true")) {
            intent = new Intent(DummyFourScrRand.this, DummySixScrRand.class);
        }
        else {
            intent = new Intent(DummyFourScrRand.this, HomeActivityScrRand.class);
        }
