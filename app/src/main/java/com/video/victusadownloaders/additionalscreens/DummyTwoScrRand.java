...
public class DummyTwoScrRand extends AppCompatActivity {
    ...
    private void startActivity() {
        Intent intent;
        if (new PrefManagerVideo(DummyTwoScrRand.this).getString(SplashActivityScr.status_dummy_three_enabled).contains("true")) {
            intent = new Intent(DummyTwoScrRand.this, DummyThreeScrRand.class);
        } else if (new PrefManagerVideo(DummyTwoScrRand.this).getString(SplashActivityScr.status_dummy_four_enabled).contains("true")) {
            intent = new Intent(DummyTwoScrRand.this, DummyFourScrRand.class);
        }
        else if (new PrefManagerVideo(DummyTwoScrRand.this).getString(SplashActivityScr.status_dummy_five_enabled).contains("true")) {
            intent = new Intent(DummyTwoScrRand.this, DummyFiveScrRand.class);
        }
        else if (new PrefManagerVideo(DummyTwoScrRand.this).getString(SplashActivityScr.status_dummy_six_enabled).contains("true")) {
            intent = new Intent(DummyTwoScrRand.this, DummySixScrRand.class);
        }else {
            intent = new Intent(DummyTwoScrRand.this, HomeActivityScrRand.class);
        }
