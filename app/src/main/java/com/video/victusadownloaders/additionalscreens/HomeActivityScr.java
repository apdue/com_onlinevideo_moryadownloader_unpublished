...
public class HomeActivityScr extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.btnYt).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(HomeActivityScr.this, MainActivity.class);
                AdsWork.showInterAds(HomeActivityScr.this, new AdsWork.AdFinished() {
                    @Override
                    public void onAdFinished() {
                        startActivity(i);
                    }
        ...
        findViewById(R.id.btnSocial).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(HomeActivityScr.this, StatusMainActivityVideo.class);
                AdsWork.showInterAds(HomeActivityScr.this, new AdsWork.AdFinished() {
                    @Override
                    public void onAdFinished() {
                        startActivity(i);
...
//            }
//        }
        if (!PermissionUtil.isAllStoragePermissionsGranted(HomeActivityScr.this)) {
...
//                            String[listPermissionsNeeded.size()]), type);
            PermissionUtil.requestAllStoragePermissions(HomeActivityScr.this,type);
            return false;
        } else {
            if (type == 101) {
                callInstaActivity();
